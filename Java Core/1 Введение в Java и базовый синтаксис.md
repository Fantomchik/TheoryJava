- [1. Все примитивные типы и их размеры java](#1-все-примитивные-типы-и-их-размеры-java)
- [2. Какая размерность у boolean?](#2-какая-размерность-у-boolean)
- [3. Что такое char? Почему над ним можно выполнять арифметические операции?](#3-что-такое-char-почему-над-ним-можно-выполнять-арифметические-операции)
- [4. Какие есть виды приведения типов? Что такое явные и неявные приведения, с чем связано их наличие?](#4-какие-есть-виды-приведения-типов-что-такое-явные-и-неявные-приведения-с-чем-связано-их-наличие)
- [5. Какие классы-обертки знаешь?](#5-какие-классы-обертки-знаешь)
- [6. Расскажи про unboxing, autoboxing в обертках](#6-расскажи-про-unboxing-autoboxing-в-обертках)
- [7. Расскажи про pool строк и pool примитивов](#7-расскажи-про-pool-строк-и-pool-примитивов)
- [8. Как добавить String’у в pool строк? ](#8-как-добавить-stringу-в-pool-строк)
- [9. Разница между String, StringBuilder и StringBuffer?](#9-разница-между-string-stringbuilder-и-stringbuffer)
- [10. Что такое массив и какие на нём есть ограничения?](#10-что-такое-массив-и-какие-на-нём-есть-ограничения)
- [11. Какая максимальная длина массива?](#11-какая-максимальная-длина-массива)
- [12. Что такое инкремент и декремент?](#12-что-такое-инкремент-и-декремент)
- [13. Какие логические операции знаешь? Таблица истинности операторов.](#13-какие-логические-операции-знаешь-таблица-истинности-операторов)
- [14. Какие есть условные операторы?](#14-какие-есть-условные-операторы)
- [15. Какие есть циклы в Java? Чем отличаются друг от друга?](#15-какие-есть-циклы-в-java-чем-отличаются-друг-от-друга)
- [16. Что такое continue и break?](#16-что-такое-continue-и-break)
- [17. Что такое рекурсия? Недостатки и преимущества?](#17-что-такое-рекурсия-недостатки-и-преимущества)
...
## 6. Расскажи про unboxing, autoboxing в обертках 📦➡️🔢
...
## 9. Разница между String, StringBuilder и StringBuffer? 🔤🔧⚙️
...
## 13. Какие логические операции знаешь? Таблица истинности операторов. ⚖️🔲💡
